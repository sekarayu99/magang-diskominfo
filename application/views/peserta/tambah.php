<section class="content">
  ...
  <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?= base_url('peserta/simpan');?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="id_peserta" class="col-sm-2 control-label">Id Peserta</label>

                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id_peserta" name="id_peserta" value="<?= $id_peserta;?>" placeholder="Id Peserta" readonly> 
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="id_asal" class="col-sm-2 control-label">Asal</label>
